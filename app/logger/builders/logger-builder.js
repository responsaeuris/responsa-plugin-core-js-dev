...
module.exports = (req, res, err, elapsed) => ({
  ...
  requestQueryString: isValidObject(req.query) ? JSON.stringify(req.query) : '',
  requestQueryStringHasValue: isValidObject(req.query),
  requestHeaders: req.headers,
  requestHeadersCount: req.headers.length,
  responseBody: hasValue(res.payload) ? (isValidJSON(res.payload) ? res.payload : JSON.stringify(res.payload)) : '',
